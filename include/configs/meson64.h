...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"mmc_boot=setenv bootargs -D /soc/sd@d0072000/blkdev@0 && fatload mmc 0 ${kernel_addr_r} inetboot && fatload mmc 0 ${fdt_addr_r} meson-gxbb-odroidc2.dtb && bootm ${kernel_addr_r} - ${fdt_addr_r}\0" \
