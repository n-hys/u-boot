...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"mmc_boot=setenv bootargs -D /emmc2bus/emmc2@7e340000 && fatload mmc 0 ${kernel_addr_r} inetboot && fdt addr ${fdt_addr} && fdt move ${fdt_addr} ${fdt_addr_r} 0x10000 && bootm ${kernel_addr_r} - ${fdt_addr_r}\0" \
